...
\begin{document}
	...
	\section{Cana-de-açúcar variedade RB867515}
		\begin{figure}[H]
			\centering
			\subfloat[Transpiração1]{\label{fig:Transpiração1}\includegraphics[width=.49\linewidth]{assets/cana/g1_20150817}}
			...
			\subfloat[Transpiração/PAR]{\label{fig:Transpiração/PAR1}\includegraphics[width=.49\linewidth]{assets/cana/g4_20150817}}\\
			\subfloat[Transpiração/DPV]{\label{fig:Transpiração/DPV1}\includegraphics[width=.49\linewidth]{assets/cana/g5_20150817}}
